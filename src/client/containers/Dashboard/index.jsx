          ...
          <Grid>
            ...
            <GridItem width={'1-1'} extraClass={'uk-margin-medium-top'} aria-label="Ticket Breakdown">
              <TruCard
                ...
                content={
                  <div className='mGraph mGraph-panel' style={{ minHeight: 200, position: 'relative' }} aria-hidden="true">
                    <MGraph
                      height={250}
                      x_accessor={'date'}
                      y_accessor={'value'}
                      ...
                      <tbody>
                        ...
                        <tr className='uk-table-middle'>
                          ...
                          <td className='uk-width-4-10 uk-text-right  uk-text-small'>
                            <a id='mostActiveTicket' href='#' aria-label={`Most active ticket: ${this.props.dashboardState.mostActiveTicket?.get('uid') || 'N/A'}`}>
