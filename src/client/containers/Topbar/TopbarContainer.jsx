...
class TopbarContainer extends React.Component {
  ...
  // add this for live reading the notifications count
  componentDidUpdate(prevProps) {
    // Add this method to handle notification updates
    if (prevProps.notificationCount !== this.notificationCount) {
                ...
                <div className="top-menu uk-float-right">
                  <ul className="uk-subnav uk-margin-bottom-remove" role="menubar">
                    ...
                    {this.notificationCount > 0 && (
                      <span aria-live="polite" role="status" style={{ visibility: 'hidden', position: 'absolute' }}>
                        {`You have ${this.notificationCount} unread notifications.`}
                      </span>
                    )}
